<template>
  <div>
    ...
    <Page :total="total" show-sizer @on-change="changePage" @on-page-size-change="pageSizeChange"/>
...
export default {
  ...
  methods: {
    ...
    handleSearch() {
      ...
      this.siglePageData = this.insideTableData.slice(0,this.pageSize);
    ...
    changePage(index) {
      ...
      this.siglePageData = this.insideTableData.slice(_start, _end);
    },
